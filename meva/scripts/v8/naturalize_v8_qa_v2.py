...
def _preprocess_temporal(qa: Dict, strip_camera_refs: bool = False) -> Dict:
    ...
    if act_1.lower() == act_2.lower():
        # Same activity on different cameras: use camera to differentiate
        options = [
            f"The event on camera {cam_1} occurred first",
            f"The event on camera {cam_2} occurred first",
            "They occurred simultaneously",
            "Cannot be determined",
        ]
    else:
        options = [
            f"{act_1} (camera {cam_1}) occurred first",
            f"{act_2} (camera {cam_2}) occurred first",
            "They occurred simultaneously",
            "Cannot be determined",
        ]
...
CATEGORY_EXAMPLES_V3 = {
    "temporal": {
        "hint": "This is a temporal ordering question about two events. Person descriptions (clothing, objects) identify who is who — there are NO camera references in the question. Cameras only appear in answer options. VARY your phrasing creatively.",
    ...
    "spatial": {
        "hint": "Spatial distance question about two people. Use their appearance descriptions to identify them. No camera references. VARY phrasing.",
        ...
        "example_output": '{"question": "How far apart would you say the person in blue with the black graphic hoodie is from the one wearing a white Puma hoodie and camo pants?", "options": ["They are near each other (within a few meters)", "They are at a moderate distance (5-15 meters)", "They are far apart (more than 15 meters)", "They are at the same location"], "reasoning": "Their positions in the scene place them approximately 6 meters apart."}',
    },
    "perception": {
        "hint": "Perception question about activities or visual attributes. Camera references are part of the question — keep them. VARY phrasing.",
        "example_input": 'A person is visible on camera G423. What color are they wearing on their lower body?',
        "example_output": '{"question": "Check camera G423 — what color is the person there wearing below the waist?", "options": ["Gray", "Navy", "Blue", "Brown"], "reasoning": "The person visible on G423 has blue pants on."}',
    },
    "re_identification": {
        "hint": "Person re-identification across cameras. Camera refs are essential. Appearance descriptions must be precise. VARY phrasing.",
